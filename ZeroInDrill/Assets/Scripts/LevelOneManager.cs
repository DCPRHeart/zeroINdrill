...
public class LevelOneManager : MonoBehaviour
{
    ...
    void Start() {
        ...
        targetOne.GetComponent<Target>().rotationSpeed = 10;
        ...
        targetTwo.GetComponent<Target>().rotationSpeed = -20;
        ...
        targetThree.GetComponent<Target>().rotationSpeed = 20;
        ...
        targetFour.GetComponent<Target>().rotationSpeed = -30;
        ...
        targetFive.GetComponent<Target>().rotationSpeed = 30;
    }
